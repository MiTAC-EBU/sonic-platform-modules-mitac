 ...
 **********************************************************************
 *
 * @filename  bms_sb_i2c.c
 *
 * @purpose   Driver to instantiate BMS switch board i2c devices
 *
 * @create    2017/1/5
 *
 ...
 */
/* switch board module i2c topology
 *
 *                                            +------------+
 *                                            | MAC_AVS_1V |
 *                                          +-|   IR3539   |
 ...
 *                |            |            | |  (2:0x51)  |
 *                |            |------------+ +------------+
 *                | I2C Switch |---------------(fan board for controller)
 *                |            |------------+ +------------+
 *                |            |----------+ | |Ther. Sensor|
 *                |  PCA9548   |--------+ | +-|   TMP75    |
 *                |            |------+ | | | |  (4:0x4A)  |
 ...
 *              |                 | | | | | | |  (4:0x4C)  |
 *              | +------------+  | | | | | | +------------+
 *              +-| Slave CPLD |  | | | | | +--(fan board for thermal)
 *                |   LCMXO3   |  | | | | +----(power board)
 *                |  (1:0x33)  |  | | | |
 *                +------------+  | | | |     +------------+  +--------------+
 *                                | | | |     | I2C Switch |  |   ZQSFP28    |
 ...
 *                                | | |       +------------+  +--------------+
 *                                | | |       | I2C Switch |  |    ZQSFP28   |
 *                                | | +-------|  PCA9548   |--| Modules[9:16]|
 *                                | |         |  (7:0x72)  |  | (18~25:0x50) |
 *                                | |         +------------+  +--------------+
 *                                | |         +------------+  +--------------+
 *                                | |         | I2C Switch |  |   ZQSFP28    |
 *                                | +---------|  PCA9548   |--|Modules[17:24]|
 *                                |           |  (8:0x73)  |  | (26~33:0x50) |
 *                                |           +------------+  +--------------+
 *                                |           +------------+  +--------------+
 *                                |           | I2C Switch |  |   ZQSFP28    |
 *                                +-----------|  PCA9548   |--|Modules[25:32]|
 *                                            |  (9:0x74)  |  | (34~41:0x50) |
 *                                            +------------+  +--------------+
 */
...
MODULE_DESCRIPTION("BMS Switch Board I2c driver");
